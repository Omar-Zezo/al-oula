      ...
      <div className="flex flex-col gap-2">
        ...
        {event?.facility_type !== null && (
          <button
            ...
            className={`w-fit mt-5 py-3 px-6 ${langDetection === "en" ? 'rounded-r-full':'rounded-l-full'} bg-mainColor hover:bg-secondryColor duration-300 text-white text-lg font-bold`}
          >
            {t("book the event")}
          </button>
        )}
